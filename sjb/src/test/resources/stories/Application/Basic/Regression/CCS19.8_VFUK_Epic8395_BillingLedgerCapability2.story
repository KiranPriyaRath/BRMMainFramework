...
Scenario: AppDirect13 CCS 19.8_VFUKE-8395_Build Ledger Billing Capability_TS02_Validate that the customer having account type Regional is purchasing the AppDirect service successfully
Meta:@AppDirect13
@Kiran
@FolderName AppDirect13
Given Pre-requisite with logs in folder 'FolderName'
...
When DrillDown to BillingProfile 'DrillDownToBillingProfile'
Then Unbilled Event Level Adjustment selection 'DrillDownToMsisdn'
And Unbilled Type of Usage Adjustment selection 'MarketUsageBillLevel'
When Validate Itemised List Selection TopUp 'LicenceCheck'


Scenario: AppDirect14 CCS 19.8_VFUKE-8395_Build Ledger Billing Capability_TS32_Validate the default CRI and credit limit for the Major account type and no credit alert actions are configured
Meta:@AppDirect14
@Kiran
@FolderName AppDirect14
Given Pre-requisite with logs in folder 'FolderName'
Given Login with 'APPDIRECT' in 'Env'
...
And Show All Purchase Products in the account ''
Given Generate First Bill
When Execute query 'CRIValueCheckAppDirect'
When Execute query 'MajorRegionalCreditCheck'
Given Rate a 'AppDirect' CDR
When Execute query 'ComparingtheRatingValue'
When Execute query 'CreditAlertCountAppDirect'

Scenario: AppDirect15 CCS 19.8_VFUKE-8395_Build Ledger Billing Capability_TS20_Extract and validate the itemizedInvoiceGenerate.xml report
Meta:@AppDirect15
@Kiran
@FolderName AppDirect15
Given Pre-requisite with logs in folder 'FolderName'
Given Login with 'APPDIRECT' in 'Env'
When Create the account type 'SmallBusinessMajorPublicOnline'
And Create 'NewOrderNoPopUp' 'NewPostpaid' Order
